...
print("This code working because anywhere in the code, your're able to change the value of the variable that you created. This is different than trying to update a contant because with constants, you aren't able to change the value of a variable.")
